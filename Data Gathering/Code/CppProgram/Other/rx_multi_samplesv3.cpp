...
int UHD_SAFE_MAIN(int argc, char *argv[]){
    ...
    double rate, freq, gain, bw, total_time, setup_time, to_collect;
    ...
    desc.add_options()
        ...
        ("to_collect", po::value<double>(&to_collect), "number of sampling runs to collect in this file")
    ...
    std::cout << boost::format("Amount      %d") % to_collect << std::endl;
