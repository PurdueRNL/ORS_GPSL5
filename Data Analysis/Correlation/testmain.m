...
% freq_c = 1575.42e6;
freq_c = 2343.125e6;
alldata_filter = data_load_cpp('G:\HanData\XMLL_20160221T145059Z_1', 'G:\HanData\XMLL_20160221T145059Z_2', 'int16');
%load('C:\Users\rnllab\Downloads\Corr_NRL\Corr\matlab1.mat')
%alldata_filter(1:2000000,1)=data_I(2000001:4000000)'+j*data_Q(2000001:4000000)';
%load('C:\Users\rnllab\Downloads\Corr_NRL\Corr\matlab2.mat')
%alldata_filter(1:2000000,2)=data_I(2000001:4000000)'+j*data_Q(2000001:4000000)';


int_time = 1;

chunk_size = int_time * .001 * samp_rate;
numcycles = floor(size(alldata_filter,1)/chunk_size);
numseconds = size(alldata_filter,1)/samp_rate;
...
%% Narrow correlation range to be plotteddata_I, data_Q
...
% t=t-mod(t,4000);
% 
% alldata = [A(1:floor(t)), B(1:floor(t))];
% fclose all;

fid_dat_A = fopen(file1);
fid_dat_B = fopen(file2);
% fseek(fid_dat_A,1+4*1300,-1);
% fseek(fid_dat_B,1,-1);
