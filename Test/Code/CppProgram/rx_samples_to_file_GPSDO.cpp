...
void benchmark_rx_rate(
    ...
    std::string file3("/home/radionavlab/Desktop/HanData/StartTime.dat");
    ...
    std::ofstream outfile[num_chan+1];
    //for (size_t i=0; i<num_chan; i++)
      ...
      //outfile[2].open((boost::format("%s") % file3 ).str().c_str(), std::ofstream::binary); 


   /********************added on 10/22/2015 for GPSDO testing*******************************/
  ...
  // usrp->set_clock_source("gpsdo",0);
   ...
   uhd::time_spec_t v2=usrp->get_time_last_pps();
   uhd::time_spec_t v3;
   std::cout<<usrp->get_mboard_sensor("gps_time").to_pp_string()<<std::endl;
  // std::cout<<boost::format("%s") % v.get_full_secs()<<std::endl;
   std::cout<<boost::format("USRP time: %s ") % v.get_full_secs();
   std::cout<<boost::format("%s senconds") % v.get_frac_secs()<<std::endl;
   std::cout<<std::endl;
   
/*   v=usrp->get_time_now();
   std::cout<<boost::format("%s") % v.get_frac_secs()<<std::endl;
   v=usrp->get_time_now();
   std::cout<<boost::format("%s") % v.get_frac_secs()<<std::endl;
   v=usrp->get_time_now();
   std::cout<<boost::format("%s") % v.get_frac_secs()<<std::endl;
   ...
   v=usrp->get_time_now();
   std::cout<<boost::format("%s") % v.get_frac_secs()<<std::endl;
  // std::cout<<boost::format("%s") % v2.get_full_secs()<<std::endl;
   std::cout<<boost::format("%s") % v2.get_frac_secs()<<std::endl;
   std::cout<<boost::format("%s") % v2.get_real_secs()<<std::endl;
   v3=usrp->get_time_last_pps();
   std::cout<<boost::format("%s") % v3.get_frac_secs()<<std::endl;
      v3=usrp->get_time_last_pps();
   std::cout<<boost::format("%s") % v3.get_frac_secs()<<std::endl;
      v3=usrp->get_time_last_pps();
   std::cout<<boost::format("%s") % v3.get_frac_secs()<<std::endl;
   ...
   //usrp->set_clock_source("gpsdo",0);
   v3=usrp->get_time_last_pps();
 //  std::cout<<boost::format("%s") % v3.get_full_secs()<<std::endl;
   std::cout<<boost::format("%s") % v3.get_frac_secs()<<std::endl;
 //  std::cout<<boost::format("%s") % v2.get_full_secs()<<std::endl;
 //  std::cout<<boost::format("%s") % v2.get_frac_secs()<<std::endl;
 //  std::cout<<usrp->get_mboard_sensor("ref_locked").to_pp_string()<<std::endl;
   }*/
   std::string gps_lock_str = usrp->get_mboard_sensor("gps_locked").to_pp_string();
   std::cout<<gps_lock_str<<std::endl;
   std::cout<<usrp->get_mboard_sensor("ref_locked").to_pp_string()<<std::endl;
/*   std::cout<<usrp->get_mboard_sensor("ref_locked").to_pp_string()<<std::endl;
   std::cout<<usrp->get_mboard_sensor("ref_locked").to_pp_string()<<std::endl;
   std::cout<<usrp->get_mboard_sensor("ref_locked").to_pp_string()<<std::endl;
...
/***********************End of GPSDO testing***********************/
    ...
    std::string abc=str( boost::format("/home/rnl_lab/Desktop/HanData/%s.dat") % start_time.time_of_day().total_milliseconds());
    std::cout << abc << std::endl;
    //outfile[3].write((boost::format("%s") % abc).str().c_str(),sizeof(boost::format("%s") % abc).str());
    outfile[2].open((boost::format("%s") % abc).str().c_str(), std::ofstream::binary);
...
//		std::cout << "Packet size tracking enabled - will only recv one packet at a time!" << std::endl;
    ...
    double sleep_time = total_time + 0.1;//was 0.1
    boost::system_time start = boost::get_system_time();
